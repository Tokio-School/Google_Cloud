...
- crear cola de tareas en consola
- enviar tarea en consola
- enviar tarea en diferido

### Tarea 2: Desplegar aplicaciones
xxx

#### Desplegar aplicación worker
- crear app en GAE/CF
- enviar tarea
- comprobar que la consume

#### Desplegar aplicación que envía tareas
- crear app en GAE/CF
- enviar tarea
- comprobar que la consume

## Resumen de entregas
1. M2U6-3-preguntas.txt: Respuestas a todas las preguntas planteadas en el ejercicio.
